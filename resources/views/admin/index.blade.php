...
<body>
  <section id="container">
    ...
    <li class="sub-menu">
      ...
      <li> <a  href="{{ route('superviseurs.index') }}" ><span class="fas fa-list-alt"> </span> Liste des Superviseurs</a></li>
      <li> <a  href="{{ route('superviseurs.create') }}"><span class="fas fa-list-alt"> </span> Ajout un Superviseur</a></li>
     ...
     <li class="sub-menu">
      ...
      <li> <a  href="{{ route('categorie_evenements.index') }}" ><span class="fas fa-list-alt"> </span> Liste des Evenement</a></li>
      <li> <a  href="{{ route('categorie_evenements.create') }}" ><span class="fas fa-list-alt"> </span> Ajout un Evenement</a></li>
     ...
     <li>
      ...
      <li> <a  href="{{ route('categorie_services.index') }}" ><span class="fas fa-list-alt"> </span> Liste des Services</a></li>
