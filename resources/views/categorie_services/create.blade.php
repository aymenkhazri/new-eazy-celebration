...
<div class="row">
    <div class="col-lg-12 margin-tb">
        ...
        <br>
<br>
            <font size="5" color="#4d1919">Créer une nouvelle type services : </font>
        </div>
...
@endif
   <br>
   <br>
<form action="{{ route('categorie_services.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
     <div class="">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Type Service :</strong>
                <input type="text" name="type_service" class="form-control" placeholder="type_service">
            </div>
        </div>
