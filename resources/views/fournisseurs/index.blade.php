        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav  navbar-right">
					...
					<a class="navbar-brand page-scroll" href="#page-top"  >Eazy-Celebration Fournisseur <i class="fas fa-glass-cheers"></i> </a>
                    </li>
					<li>
                        <a class="page-scroll" href="{{ url('/fournisseur/accueil') }}">Accueil</a>
                    </li>
                   
					<li>
					<a class="page-scroll" href="{{ url('/fournisseur/demandes') }}"> Annonces</a> 
                    </li>
					<li>
					
					<a class="page-scroll" href="{{ url('/fournisseur/boit_chat') }}">Boit chat</a>
				   </li>
                   <li>
  ...
  <div class="modal fade" id="profil" role="dialog">
   ...
   <div class="col-xs-12 col-sm-12 col-md-12">
	...
	<div class="col-xs-12 col-sm-12 col-md-12">
				 ...
				 <h3>Type de service: {{ Auth::user()->type_service_id }}</h3>
				 </div>
			 </div>    
		 </div>
...
<div class="modal-footer">
    ...
    <a  href="{{  url('/fournisseur/edit_profile') }}" > <button type="submit" class=" btn btn-sm btn-primary" > Modifier</button></a>
